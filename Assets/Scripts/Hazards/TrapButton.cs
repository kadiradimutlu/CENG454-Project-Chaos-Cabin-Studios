...
public class TrapButton : NetworkBehaviour
{
    ...
    {
        Debug.Log($"[TrapButton] {name}: PressButton(). slowField atandı mı={slowField!=null}, minefield atandı mı={minefield!=null}, Object null mu={Object==null}", this);
    ...
    {
        Debug.Log($"[TrapButton] {name}: TriggerBoundTrap. slowField={slowField!=null}, minefield={minefield!=null}", this);
        ...
        if (slowField == null && minefield == null)
            Debug.LogWarning($"[TrapButton] {name}: HİÇBİR slot dolu değil! Inspector'da Slow Field veya Minefield'a trap sürükle.", this);
    }
