...
public struct GameplayInput : INetworkInput
{
    ...
    public NetworkBool SprintButton;
    public NetworkBool CrouchButton;
}
...
public class PlayerInput : NetworkBehaviour, INetworkRunnerCallbacks
{
    ...
    public void OnInput(NetworkRunner runner, NetworkInput input)
    {
        ...
        if (keyboard.spaceKey.isPressed) myInput.JumpButton = true;
        if (keyboard.leftShiftKey.isPressed) myInput.SprintButton = true;
        if (keyboard.leftCtrlKey.isPressed) myInput.CrouchButton = true;
